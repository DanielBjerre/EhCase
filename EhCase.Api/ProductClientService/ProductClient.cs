...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        {
            _baseUrl = "https://azfun-impact-code-challenge-api.azurewebsites.net/";
        ...
        public virtual async System.Threading.Tasks.Task<OrderResponse> CreateOrderAsync(CreateOrderRequest body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/CreateOrder"
                    urlBuilder_.Append("api/CreateOrder");
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<ProductResponse>> GetAllProductsAsync(System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/GetAllProducts"
                    urlBuilder_.Append("api/GetAllProducts");
        ...
        public virtual async System.Threading.Tasks.Task<OrderResponse> GetOrderAsync(string orderId, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/GetOrder/{orderId}"
                    urlBuilder_.Append("api/GetOrder/");
    ...
    public partial class OrderLine
    {
        ...
        [System.Text.Json.Serialization.JsonPropertyName("productUnitPrice")]
